...
@CucumberOptions(
		...
		features = "src/test/resources/features/Cleartrip.feature",
		glue = { "com.CucumberCraft.stepDefinitions" }, 
		tags = {"@CleartripFlightSearch2" }, monochrome = true, plugin = { "pretty", "pretty:target/cucumber-report/Smoke/pretty.txt",
